...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{images/rlocus.jpg}
...
\end{figure}
Next the Kp increases to $40.00$ and the following perforamnce of the system can be observed:
\begin{itemize}
...
\end{figure}
The perfoamnce has technically inproved when it comes to rise time and settling time, however the desired rise time is around 1 second so it isn't an improvemnt for the desired system. The overshoot has decreased significantly with $20\%$ which is a huge improvement. Still, however, far from the desired 1\%. The steady state error is eliminated as the previous with try, observed on figure \ref{my_second_step}. This time the Kp has increased to $60.00$.
\begin{itemize}
...
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{images/sim_input_step.jpg}
  \caption{the input of step response of the simulated linearized system} \label{my_input_step_li}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{images/sim_output_step.jpg}
...
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{images/sim_input_step_unlin.jpg}
  \caption{the input of step response of the simulated nonlinear system} \label{my_input_step_pid}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{images/sim_output_step_unlin.jpg}
  \caption{the output of the step response of the simulated nonlinear system} \label{my_output_step_pid}
\end{subfigure}
\caption{A figure that shows the step response input and output of the simulated nonlinear system.}
\label{fig:ste_unli}
\end{figure}
